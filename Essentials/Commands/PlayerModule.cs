...
namespace Essentials
{
    public class PlayerModule : CommandModule
    {
        ...
        {
            Context.Torch.Managers.GetManager<IChatManagerServer>().SendMessageAsOther("Server", Context.RawArgs, MyFontEnum.Blue);
        }
        ...
        public void Whisper(string playerName)
        {
            ...
            var player = Context.Torch.Managers.GetManager<IMultiplayerManagerBase>().GetPlayerByName(playerName);
            ...
            Context.Torch.Managers.GetManager<IChatManagerServer>().SendMessageAsOther(message, Context.Player?.DisplayName ?? "Server", MyFontEnum.Red, player.SteamUserId);
        }
        ...
        public void Kick(string playerName)
        {
            ...
            if (player != null)
            {
                Context.Torch.Managers.GetManager<IMultiplayerManagerServer>().KickPlayer(player.SteamUserId);
        ...
        public void Ban(string playerName)
        {
            ...
            if (player != null)
            {
                Context.Torch.Managers.GetManager<IMultiplayerManagerServer>().BanPlayer(player.SteamUserId);
        ...
        public void Unban(string playerName)
        {
            ...
            if (player != null)
            {
                Context.Torch.Managers.GetManager<IMultiplayerManagerServer>().BanPlayer(player.SteamUserId, false);
